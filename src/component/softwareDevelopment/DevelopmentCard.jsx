...
const DevelopmentCard = () => {
  return (
    <section className="benefit_card padding-block padding-inline xl:mx-[100px] lg:mx-[100px]   ">
      <h3
        className="text-black font-extrabold font-primary tracking-[0.5px] lg:text-[45px] sm:text-[30px] text-[28px] capitalize sm:mb-[50px] mb-[30px] text-center leading-none"
