...
const ContactHeader = () => {
    return (
        <div className='contact_header padding-inline xl:mx-[100px] md:mx-[50px] padding-block sm:mt-2 mt-[50px] sm:mb-0 mb-[30px] '>
            <div className=' text-center about_work_section  sm:pb-[30px] flex items-center justify-center flex-col' data-aos='zoom-in' data-aos-duration='1800'>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1  lg:gap-[25px] gap-[20px] mt-[30px]">
                <div className='contact_header_card sm:py-5 py-3  xl:px-8 px-4 rounded-3xl shadow-xl border border-[#E8E8E8] bg-white flex items-center justify-between'  data-aos='fade-up' data-aos-duration='1800' >
