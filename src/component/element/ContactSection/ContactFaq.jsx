...
const ContactFaq = () => {
    ...
    return (
        <div className='md:py-[60px] py-[40px] xl:px-[70px] px-[25px] rounded-[30px] bg-blue drop-shadow-1xl lg:mx-[150px] md:mx-[100px] mx-[30px] md:mb-[100px] mb-[50px]'>
            <h2 className='text-white font-bold text-primary md:text-[35px] sm:text-[30px] text-[25px] md:leading-none  leading-tight  lg:mb-10 mb-6  text-center capitalize' data-aos='zoom-out' data-aos-duration='1800' >Frequently Asked Questions</h2>
