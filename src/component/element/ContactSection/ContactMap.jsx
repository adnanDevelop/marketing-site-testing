...
const ContactMap = () => {
    return (
        <div className='contact_map-section padding-inline lg:mb-[100px] md:mb-[70px] mb-[50px] '>
            <h2 className='text-black font-bold text-primary xl:text-[50px] md:text-[40px] text-[30px]  leading-none lg:mb-10 mb-6  text-center capitalize' data-aos='zoom-in-out' data-aos-duration='1800'>Find us here</h2>
