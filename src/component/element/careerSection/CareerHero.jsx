...
const CareerHero = () => {
    return (
        <div className='career_hero_section pb-[80px] padding-inline relative overflow-x-hidden'>
            ...
            <div className="xl:px-[150px] md:mx-[50px]  grid sm:grid-cols-2 grid-cols-1 sm:gap-y-0 gap-y-4  lg:gap-x-[30px] md:gap-x-[20px] gap-x-[15px]" data-aos='zoom-in-out' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">
                <div className='flex items-center justify-center'>
                    <img src="/image/career/career-header/img-1.jpg" className='w-full lg:h-[450px] h-[300px] rounded-[30px] object-cover' alt="" />
                </div>
                <div className='flex items-center justify-center'>
                    <img src="/image/career/career-header/img-2.jpg" className='w-full lg:h-[450px] h-[300px] rounded-[30px] object-cover' alt="" />
                </div>
            </div>
