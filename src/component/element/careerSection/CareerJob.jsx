        ...
        <div className='career_job_section padding-block padding-inline'>
            ...
            <div className="career_job_card grid md:grid-cols-2  grid-cols-1 md:gap-[20px] gap-[15px]  xl:mx-[100px]   ">
                {jobContent.map((element, index) => {
                    return (
                        <div key={index} data-aos='zoom-in-up' data-aos-duration='1800' data-aos-anchor-placement="center-bottom" >
                ...
                {/* CAN'T FIND CARD */}
                <div className=' md:col-span-2  career_card border  md:py-[100px] py-[50px] sm-px-1 px-[20px]  border-[#CBCBCB]  rounded-[20px] flex items-center justify-center flex-col transition duration-500 group hover:bg-blue' data-aos='zoom-in-up' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">
