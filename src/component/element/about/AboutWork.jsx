...
const AboutWork = () => {
  return (
    <div className=' text-center about_work_section padding-inline padding-block flex items-center justify-center flex-col' data-aos='fade-zoom-in' data-aos-duration='1800' data-aos-anchor-placement="center-bottom" >
