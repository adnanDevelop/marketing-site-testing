...
import { testContent } from "../../Data/Api";
  ...
  return (
    <div className="testmonial_section  padding-inline">
      ...
      <div className="testmonial_header flex items-center justify-between ">
        <h2 className="text-black font-[800] capitalize  xl:text-[35px] sm:text-[30px] text-[25px]" data-aos='zoom-in-out' data-aos-duration='1500' >
          client testmonials
        </h2>
      ...
      <div className="testmonial_card_section relative ">
        <div className="quote_icon_one absolute z-[10] sm:top-[15px] top-[20px] ">
          <img src="/image/testmonial/quote-1.png" className="sm:w-[45px] w-[35px]" alt="" />
        </div>
        <div className="quote_icon_two absolute z-[10] right-0 sm:bottom-[15%] lg:bottom-[18%] md:bottom-[18%] bottom-[13%] rotate-[180deg] ">
          <img src="/image/testmonial/quote-1.png" className="sm:w-[45px] w-[35px]" alt="" />
        </div>
        <Swiper
          slidesPerView={3}
          ...
          {testContent.map((element, index) => {
            return (
              <SwiperSlide className="lg:px-[10px] px-[5px]" key={index}>
                ...
                >
                  <p className="text-justify mb-[20px] text-[18px]">{element.content}</p>
