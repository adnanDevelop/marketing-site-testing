  ...
  return (
    <div className="testmonial_section  padding-inline">
      ...
      <div className="testmonial_card_section relative ">
        <div className="quote_icon_one absolute z-[10] top-[15px] ">
          <img src="/image/testmonial/quote-1.png" className="sm:w-[60px] w-[50px]  " alt="" />
        </div>
        <div className="quote_icon_two absolute z-[10] right-0 bottom-[15%] rotate-[180deg] ">
          <img src="/image/testmonial/quote-1.png" className="sm:w-[60px] w-[50px]  " alt="" />
        </div>
        <Swiper
          slidesPerView={3}
