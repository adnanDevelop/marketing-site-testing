  ...
  return (
    <section className="relative z-10 about_mission_section xl:py-[60px] lg:py-[30px] pt-[20px]  padding-inline md:my-[100px]  ">
      <div className="flex flex-col lg:justify-between lg:items-center lg:flex-row ">
        <div
          className="mission_content lg:basis-2/3 md:basis-2/4 basis-full lg:ps-[70px]"
          data-aos="fade-up"
          data-aos-duration="1500"
          data-aos-anchor-placement="center-bottom"
        >
          <h2 className="xl:text-[45px] lg:text-[40px] text-[30px]  text-white font-primary font-extrabold tracking-wide lg:mb-5 mb-4 ">
            Our Mission
          </h2>
