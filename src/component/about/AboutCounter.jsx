  ...
  return (
    ...
    >
      <section className="about_counter_section relative margin-inline sm:py-[50px] py-[30px]   margin-block  rounded-[30px] bg-light-white  flex sm:flex-row flex-col flex-wrap items-center  ">
        ...
        {/* CLIENT */}
        <div
          className="flex flex-col items-center justify-center mb-8 lg:basis-1/4 sm:basis-2/4 basis-full lg:mb-0"
        ...
        >
          <h2 className="text-black  font-extrabold  text-primary xl:text-[60px]  lg:text-[40px] sm:text-[35px] text-[30px]   leading-tight ">
            {counterOn && <CountUp start={0} end={24} duration={3} delay={0} />}{" "}
            <span className="text-sky-900">h</span>
          </h2>
          <p className="text-black text-secondary font-semibold capitalize xl:text-[18px] text-[14px]   ">
            Expert support team
          </p>
        ...
        >
          <h2 className="text-black font-extrabold text-primary xl:text-[60px]  lg:text-[40px] sm:text-[35px] text-[30px]  leading-tight ">
            {counterOn && <CountUp start={0} end={98} duration={3} delay={0} />}{" "}
            <span className="text-sky-900">k+</span>
          </h2>
          <p className="text-black text-secondary font-semibold capitalize xl:text-[18px] text-[14px]  ">
            sales count
          </p>
        ...
        {/*  CLIENT */}
        <div
          className="flex flex-col items-center justify-center lg:basis-1/4 sm:basis-2/4 basis-full"
          data-aos="fade-zoom-in"
          data-aos-duration="1800"
          data-aos-anchor-placement="center-bottom"
        >
          <h2 className="text-black font-extrabold text-primary xl:text-[60px]  lg:text-[40px] sm:text-[35px] text-[30px]  leading-tight ">
            {counterOn && (
              <CountUp start={0} end={208} duration={3} delay={0} />
            )}{" "}
