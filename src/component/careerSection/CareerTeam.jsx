...
const CareerTeam = () => {
    return (
        <section className=' career_team_section w-full  md:h-[65vh] h-[50vh] relative padding-inline flex lg:items-start items-center justify-center flex-col bg-sky-500 ' style={{ background: 'url(/image/career/team-bg.jpg) no-repeat right' }} >
            <div className='career_team_content md:ps-[100px] lg:text-start text-center mx-auto lg:py-0 lg:px-0 py-8 px-4 lg:rounded-0 rounded-md lg:shadow-none shadow-lg' data-aos='fade-zoom-in' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">
                <h2 className='md:text-[40px] sm:text-[25px] text-[22px] text-black leading-none capitalize font-primary font-bold tracking-wide mb-4'>We are from the people</h2>
