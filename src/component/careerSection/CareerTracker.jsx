...
const CareerTracker = () => {
    return (
        <section className='padding-block padding-inline relative '>
            ...
            <div className="tracker_header text-center xl:max-w-[50%] lg:max-w-[65%] md:max-w-[80%] mx-auto mb-[30px]">
                <h2 className='text-black font-bold font-primary tracking-wide xl:text-[50px] lg:text-[40px] text-[30px] md:mb-4 mb-2' data-aos='fade-in-out' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">Career trackers</h2>
                <p className='text-gray font-normal font-secondary  lg:px-[50px] md:px-[30px] lg:text-justify text-justify text-last-justify ' data-aos='fade-in-out' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">
                ...
                {trackerContent.map((element, index) => {
                    return (
                        <div className='tracker_card' key={index} data-aos='fade-up' data-aos-duration='1800' data-aos-anchor-placement="center-bottom">
                            ...
                            <p className='font-normal text-black lg:text-[20px] font-secondary  text-center mt-3 leading-none'>{element.title}</p>
                        </div>
                    )
                })}
            </div>
