        ...
        <section className='career_job_section padding-inline relative overflow-hidden z-10' id='job'>
            ...
            <div className="career_job_card grid md:grid-cols-2  grid-cols-1 md:gap-[20px] gap-[15px]  xl:mx-[100px]   ">
                ...
                <div className='md:col-span-2 career_card border md:py-[100px] py-[50px] sm-px-1 px-[20px] bg-white border-[#CBCBCB] rounded-[20px] flex items-center justify-center flex-col transition duration-500 group hover:bg-blue'>
                    ...
                    <Link to='/' className=' inline-block mt-4 capitalize font-[600] text-[14px] text-white bg-sky-500 rounded-full sm:px-[30px] px-[20px] sm:py-[15px] py-[10px] transition duration-300 group-hover:bg-white  group-hover:text-black group-focus:text-black'>apply now</Link>
                </div>
            </div>
        </section>
    )
