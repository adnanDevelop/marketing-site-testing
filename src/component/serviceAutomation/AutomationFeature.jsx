...
const AutomationFeature = () => {
  return (
    <div className='development_feature_section  padding-inline lg:mt-[100px] mt-[50px]'>
      <h3 className='text-black font-bold lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] sm:mb-[50px] mb-[30px] text-center' data-aos='fade-zoom-in' data-aos-duration='1800'>Key Features</h3>
      ...
      <div className="development_card_section grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px] xl:mx-[80px]" data-aos='fade-zoom-in' data-aos-duration='1800'>
        <div className={`development_feature_card  rounded-[20px] pt-[20px] pb-[50px]  transition duraiton-300 bg-white hover:bg-light-white `}>
          ...
          <div className="development_feature_card_body text-center md:px-[20px] px-[15px] ">
            <h4 className='my-3  2xl:text-[30px] lg:text-[20px]  text-black font-bold leading-none '>Consultation</h4>
        ...
        <div className={`development_feature_card bg-light-white rounded-[20px] pt-[20px] pb-[50px]  transition duraiton-300`} >
          ...
          <div className="development_feature_card_body text-center md:px-[20px] px-[15px] ">
            <h4 className='my-3 2xl:text-[30px] lg:text-[20px] text-black font-bold leading-none '>Plan, Pilot, Scale</h4>
            <p className='text-gray font-secondary font-normal'>
        ...
        <div className={`development_feature_card  rounded-[20px] pt-[20px] pb-[50px]  transition duraiton-300 bg-white hover:bg-light-white `} >
          ...
          <div className="development_feature_card_body text-center md:px-[20px] px-[15px] ">
            <h4 className='my-3 2xl:text-[30px] lg:text-[20px] text-black font-bold leading-none '>Data Capture</h4>
            <p className='text-gray font-secondary font-normal'>
