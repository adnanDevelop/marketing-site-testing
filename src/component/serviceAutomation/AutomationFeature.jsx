...
const AutomationFeature = () => {
  return (
    <section className="development_feature_section  padding-inline lg:mt-[100px] mt-[50px]">
      ...
      {/* FEATURE CARD ONE */}
      <div
        className="development_card_section grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px] xl:mx-[80px]"
        data-aos="fade-zoom-in"
        data-aos-duration="1800"
      >
        <div
        ...
        >
          ...
          <div className="development_feature_card_body text-center md:px-[20px] px-[15px] ">
            ...
            <p className="font-normal text-gray font-secondary">
              Strategically plan and pilot-scale your automation initiatives for
