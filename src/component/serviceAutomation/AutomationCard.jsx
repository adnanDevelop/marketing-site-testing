...
const AutomationCard = () => {
  return (
    <div className='benefit_card padding-block padding-inline'>
      <h3 className='text-black font-bold lg:text-[45px] md:text-[40px] sm:text-[30px] text-[28px] capitaliz sm:mb-[50px] mb-[30px] text-center' data-aos='fade-zoom-in' data-aos-duration='1800'  >Benefits of Custom Software Solutions</h3>
        ...
        {automationCardContent.map((element, index) => {
          return (
            <div key={index} className='benefit_card lg:h-[350px] h-auto lg:py-0 py-[50px]  px-[20px] border border-[#CBCBCB] bg-[#F9F9F9] rounded-[15px]  flex items-center justify-center flex-col' style={{ boxShadow: '0px 5px 25px 0px rgba(0, 0, 0, 0.07)' }} data-aos='fade-up' data-aos-duration='1800'>
              ...
              <h5 className=' my-4 font-semibold text-[18px] capitalize'>{element.title}</h5>
