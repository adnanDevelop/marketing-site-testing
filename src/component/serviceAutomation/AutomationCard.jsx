...
const AutomationCard = () => {
  return (
    <section className="benefit_card padding-block padding-inline">
      <h3
        className="text-black font-bold font-primary tracking-wide  lg:text-[45px] md:text-[40px] sm:text-[30px] text-[28px] capitaliz sm:mb-[50px] mb-[30px] text-center leading-[2rem]"
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1  gap-[20px] xl:mx-[150px] lg:mx-[60px] ">
        {automationCardContent.map((element, index) => {
          return (
            <div
              key={index}
              className="benefit_card lg:h-[350px] h-auto lg:py-0 py-[50px]  px-[20px] border border-[#CBCBCB] bg-[#F9F9F9] rounded-[15px]  flex items-center justify-center flex-col"
