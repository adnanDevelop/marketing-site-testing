    ...
    return (
        <section className='relative overflow-hidden'>
            ...
            <div className='about_work_section text-center padding-inline md:pt-[150px] pt-[100px] flex items-center justify-center flex-col' data-aos='zoom-up' data-aos-duration='1800'>
                <h2 className='text-black font-extrabold capitalize font-primary leading-none tracking-wide lg:text-[45px] md:text-[40px] sm:text-[30px] text-[28px]'>{title}</h2>
                <p className='text-gray font-normal font-secondary md:text-[18px] text-[16px]  my-3 max-w-[550px]'>{content}</p>
            </div>
        </section>
    )
}
