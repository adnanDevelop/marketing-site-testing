      ...
      <div className="service_heading_section flex lg:items-center justify-between lg:flex-row flex-col ">
        <div className=" basis-full xl:basis-1/2">
          ...
          <div className="relative z-10">
            <p className="gradient_color xl:text-[40px] lg:text-[30px] text-[25px] xl:leading-[3.5rem] lg:leading-[3rem] xl:max-w-[37rem] lg:max-w-[28rem] w-full  font-semibold font-primary xl:pe-0 lg:pe-[20px]" ref={gradientRef}>
