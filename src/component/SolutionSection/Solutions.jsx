...
const Solutions = () => {
    return (
        <section className='communication_solution padding-block padding-inline'>
            <h3 className='text-black font-extrabold font-primary tracking-wide lg:text-[45px] md:text-[40px] sm:text-[30px] text-[28px] capitalize sm:mb-[50px] mb-[30px] text-center' data-aos='zoom-in' data-aos-duration='1800' >Our VoIP Solutions</h3>
            {/* SOLUTIONS TABS */}
            <div className='grid lg:grid-cols-12 gap-x-[10px] lg:mx-[70px]'>
                        ...
                        return (
                            <div key={index} className="tab px-[10px] py-[20px] text-center rounded-[15px] border border-[#CBCBCB] bg-light-white w-full lg:max-w-[15rem] mx-auto">
                                <div>
                                    ...
                                    <p className='text-black font-extrabold font-primary text-[17px] mt-4 leading-none'>{element.title}</p>
                                </div>
                            </div>
                        )
                    })}
                ...
                <div className='solution_content xl:col-span-9 lg:col-span-8 bg-blue text-white rounded-[15px] lg:py-[50px] py-[35px]  md:px-[50px] px-[20px]  lg:mt-0 mt-4  flex items-center justify-center' data-aos='fade-zoom-in' data-aos-duration='1800'>
                    <p className='xl:text-[22px] md:text-[20px] text-[16px] xl:leading-[2.3rem] font-secondary lg:tracking-wider tracking-wide text-justify font-light'>
