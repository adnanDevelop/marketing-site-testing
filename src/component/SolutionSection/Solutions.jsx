  ...
  return (
    <section className="communication_solution padding-block padding-inline">
      ...
      <div className="grid lg:grid-cols-12 gap-x-[10px] lg:mx-[70px]">
              ...
              >
                <div>
                  <img
                    ...
                    alt=""
                  />
                  <p className="text-black font-extrabold font-primary text-[17px] mt-4 leading-none">
                    {element.title}
                  </p>
                </div>
              </div>
        ...
        <div
          className="solution_content xl:col-span-9 lg:col-span-8 bg-blue text-white rounded-[15px] lg:py-[50px] py-[35px]  md:px-[50px] px-[20px]  lg:mt-0 mt-4  flex items-center justify-center"
