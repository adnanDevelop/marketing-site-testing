...
const FeatureCard = () => {
    return (
        <div className='solution_feature_section padding-inline '>
            <h3 className='text-black font-bold lg:text-[40px] md:text-[40px] sm:text-[30px] text-[28px] sm:mb-[50px] mb-[30px] text-center' data-aos='zoom-in' data-aos-duration='1800' >Key Features</h3>
            {/* FEATURE CARD ONE */}
