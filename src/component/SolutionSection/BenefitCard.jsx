...
const BenefitCard = () => {
    return (
        <div className='benefit_card  '>
            <h3 className='text-black font-extrabold lg:text-[45px] md:text-[40px] sm:text-[30px] text-[28px] capitalize sm:mb-[50px] mb-[30px] text-center' data-aos='fade-zoom-in' data-aos-duration='1800' >Benefits of VoIP</h3>

            {/* BENEFIT CARD SECTION  */}
            <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 place-items-center gap-[30px]'>
