            ...
            <div className="grid lg:grid-cols-2 grid-cols-1  lg:gap-[25px] gap-[20px] mt-[30px] xl:mx-[100px] md:mx-[50px]" data-aos='fade-zoom-in' data-aos-duration='1800'>
                <div className='contact_header_card sm:py-4 py-3 xl:px-8 px-3 rounded-3xl shadow-xl border border-[#E8E8E8] bg-white flex items-center justify-between'>
                    <div className='icon_section flex items-center'>
                        ...
                        <p className='text-[#1B2534] sm:text-[18px] text-[15px]  font-bold font-secondary capitalize ps-3'>mail us</p>
                    </div>
                    <a href="mailto:hr@gomarkho.com" rel="noreferrer" className='no-underline text-gray sm:text-[18px] text-[15px]  font-secondarys'>hr@gomarkho.com</a>
                </div>
                {/* 2ND CARD */}
                <div className='contact_header_card sm:py-4 py-3 xl:px-8 px-3 rounded-3xl shadow-xl border border-[#E8E8E8] bg-white flex items-center justify-between' >
                    <div className='icon_section flex items-center'>
                        <img src="/image/contact/img-2.svg" className='sm:w-[60px] w-[50px]  sm:h-[60px] h-[50px]  object-cover' alt="" />
                        <p className='text-[#1B2534] sm:text-[18px] text-[15px]  font-bold font-secondary capitalize ps-3 '>call us</p>
                    </div>
