        ...
        <section className='md:py-[60px] py-[40px] xl:px-[70px] px-[20px] rounded-[30px] bg-blue drop-shadow-1xl lg:mx-[150px] md:mx-[100px] mx-[30px] md:mb-[100px] mb-[50px]'>
            ...
            <div className='mt-8 accordin_section'>
                {accordinContent.map((element, index) => {
                    ...
                    return (
                        <button key={index} className={`accordin md:py-[20px] py-[15px] sm:ps-[25px] ps-[15px] md:pe-[0px] pe-[10px] select-none bg-white rounded-3xl mb-[30px] transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'xl:mx-[120px] md:mx-[40px]' : 'xl:mx-[140px] md:mx-[60px] overflow-hidden'}`} onMouseEnter={() => handleItemClick(index)}>
                            <h4 className='text-black font-bold font-primary tracking-[0.6px] text-left xl:text-[18px] text-[13px]'>{index + 1}. {element.title}</h4>
                            <div className={`flex items-start justify-center accordin_body transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[200px] visible opacity-100' : 'invisible opacity-0 max-h-0'}`}>
...
<div className='mt-8 accordin_section'>
    {accordinContent.map((element, index) => {
        ...
        return (
            <button key={index} className={`accordin md:py-[20px] py-[15px] sm:ps-[25px] ps-[15px] md:pe-[0px] pe-[10px] select-none bg-white rounded-3xl mb-[30px] transition duration-300 ease-in-out overflow-hidden ${openIndex === index ? 'xl:mx-[120px] md:mx-[40px]' : 'xl:mx-[140px] md:mx-[60px] overflow-hidden'} cursor-pointer`}
